...
public class MySqlTwoClient
        extends BaseJdbcClient
{
    @Inject
    public MySqlTwoClient(JdbcConnectorId connectorId, BaseJdbcConfig config, MySqlTwoConfig mySqlConfig)
            throws SQLException
    {
        super(connectorId, config, "`", connectionFactory(config, mySqlConfig));
    }

    private static ConnectionFactory connectionFactory(BaseJdbcConfig config, MySqlTwoConfig mySqlConfig)
            throws SQLException
    {
