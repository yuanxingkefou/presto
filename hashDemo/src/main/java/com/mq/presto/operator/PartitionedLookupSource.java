        ...
        implements LookupSource
{
    ...
    private static class OuterPositionTracker
    {
        public static class Factory
        {
            ...
            public PartitionedLookupSource.OuterPositionTracker create()
            {
                return new PartitionedLookupSource.OuterPositionTracker(visitedPositions, finished, referenceCount);
            }
