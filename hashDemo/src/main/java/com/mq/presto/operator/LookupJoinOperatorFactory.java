...
import com.mq.presto.operator.LookupJoinOperators.JoinType;
...
import static com.mq.presto.operator.LookupJoinOperators.JoinType.INNER;
import static com.mq.presto.operator.LookupJoinOperators.JoinType.PROBE_OUTER;
...
//                    lookupSourceFactoryManager.getBuildExecutionStrategy()));
            this.outerOperatorFactoryResult = null;
        }
    ...
    public LookupJoinOperator createOperator(DriverContext driverContext)
    {
